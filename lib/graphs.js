...
let topStates = ["CA","AZ","OK","WA","MT","TX","ID","CO","NV","WY","UT","OR","NM","AL","NC"]
...
function selectData(x,y){
    ...
    let xSelector;
    switch (y){
        case "Number of Fires":
            ySelector = (v) => v.length;
            break;
        case "Number of Acres":
    ...
    switch(x){
        ...
        case "Top 6 Agencies":
            ...
            break;
        case "Top 15 States":
            xSelector = d => d.properties.state;
            break;
    }
