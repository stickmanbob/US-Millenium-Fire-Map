...
const mapButtons = document.getElementById("selectButtons");
const headerHeight = header.getBoundingClientRect().height;
const buttonsHeight = mapButtons.getBoundingClientRect().height;

const mapHeight = window.innerHeight - headerHeight - buttonsHeight;

mapEle.style.height = mapHeight;
console.log(mapEle);
...
// Set minimum zoom based on screen width
...
const bounds = [
    [-140.85529931614596, 15.937987412114225],
    [ -58.6732497637568, 54.88248828633945 ]
]
...
// Test function to log coordinates on click
